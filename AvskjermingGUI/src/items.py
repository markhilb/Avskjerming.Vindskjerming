...
from config import CANVAS_BASELINE, CANVAS_LEFT_START, GLASS_BASELINE, WALLMOUNT_WIDTH, \
    ...
    LENGTH_BAR_LABEL_TOP, WALLMOUNT_DISPLAY_WIDTH, POST_DISPLAY_WIDTH, POST_BASE_DISPLAY_WIDTH, \
    POST_BASE_DISPLAY_HEIGHT, WALLMOUNT_PACKAGING, POST_PACKAGING, WALLMOUNT_WEIGHT_MULTIPLYER, \
    POST_WEIGHT_MULTIPLYER, POST_MOUNT_WEIGHT, GLASS_WEIGHT_MULTIPLYER, GLASS_PACKAGING, \
    LENGTH_BAR_SIDES_HEIGHT, LEFT_HEIGHT_BAR_START, RIGHT_HEIGHT_BAR_OFFSET, \
    RIGHT_HEIGHT_LABEL_OFFSET
